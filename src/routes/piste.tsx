...
const TRACKS: Track[] = [
  { key: "vol75", name: "Volatility 75 (1s)", category: "synthetic", market: "1HZ75V (1s)", badge: "📈 Volatility 75 (1s)", thesis: "M15 Trend → M5 Regime → M1 Pullback/Breakout à haute fréquence.", engine: "Vol75 Multi-Timeframe", validation: "Démo · Score min. 80/100 · ATR 1s.", color: "text-lime-300", borderColor: "border-lime-500/30", bgTone: "bg-lime-500/10" },
