  ...
  server: {
    handlers: {
      PATCH: async ({ request }) => {
        ...
        if (body.preset !== "default" && body.preset !== "boom" && body.preset !== "crash" && body.preset !== "scalping" && body.preset !== "liquidity" && body.preset !== "gold") {
        ...
        if (body.resetToCanonical) {
          ...
          Object.assign(config, presetFieldsFor(body.preset), {
            ...
            mode: body.preset === "scalping" || body.preset === "liquidity" || body.preset === "gold" ? "demo" : mode,
          });
        }
