...
export function logSafetyAlert(params: {
  alertType: "VERSIONING_MISMATCH" | "CONFIG_HASH_MISSING" | "STAKE_SAFETY_VIOLATION" | "STAKE_BELOW_DERIV_MINIMUM" | "RISK_PAUSE_BYPASS" | "EXECUTION_WITHOUT_VALID_PROPOSAL" | "CONFIG_SNAPSHOT_MISSING" | "STAKE_MIGRATION_ANOMALY";
  userId: number;
  preset: string;
  symbol: string;
  details: string;
